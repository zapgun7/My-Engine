...
//	void SetObjectVector( std::vector< cGameObject* >* p_vecGOs );
	...
	void UpdateActiveCommands(double deltaTime);
...
//	static int l_GetObjectState( lua_State *L );
	...
	// Info setting for the other brain
	void setMeshVec(std::vector<cMesh*> newVec);
	void setPhysVec(std::vector<sPhysicsProperties*> newVec);
